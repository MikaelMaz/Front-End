...
console.log("femmine:" + femaleCharacters)
...
*/
for (let i = 0; i < starWarsCharacters.length; i++) {
  let personaggio = starWarsCharacters[i].name
  ...
  switch (eye_color) {
    ...
    case "bluegray" :
      eyeColor.bluegray.push(personaggio);
      break;
  }
}
...
let crewMass = 0
let indice = 0;
while (indice < starWarsCharacters.length) {
  crewMass += starWarsCharacters[indice].mass;
  indice++;
}
